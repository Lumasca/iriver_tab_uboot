...
//#define		SYSTEM_PART_SIZE		(250*1024*1024)
...
#define		VENDOR_PART_SIZE	(10*1024*1024)
#endif

//#if defined(CFG_MOVI_PART) && defined(MOVI_PART_TYPE >= MOVI_PART_FAT_DATA) /* ktj */
#if (MOVI_PART_TYPE >= MOVI_PART_FAT_DATA) && defined(CFG_MOVI_PART) /* ktj */
#define		USER_DATA_PART_SIZE		(500*1024*1024)
#else
...
/////////////////////////////////////////////////////////////////
#if defined(CFG_MOVI_PART)
    #if (MOVI_PART_TYPE == MOVI_PART_FAT_DATA_CACHE) /* ktj */
int make_mmc_partition(int total_block_count, unsigned char *mbr)
{
	int		block_start = 0, block_offset;

	SDInfo		sdInfo;
	PartitionInfo	partInfo[3];
...
///	block_start += block_offset;
	block_start	= calc_unit(_10MB, sdInfo); // ktj add, part print 시 block_start=0 이면 print 안되서 10mb 마진 부여함
...
///////////////////////////////////////////////////////////	
    ...
    #elif (MOVI_PART_TYPE == MOVI_PART_FAT_DATA) /* ktj */
int make_mmc_partition(int total_block_count, unsigned char *mbr)
{
	int		block_start = 0, block_offset;

	SDInfo		sdInfo;
	PartitionInfo	partInfo[2];
...
///////////////////////////////////////////////////////////	
	...
	encode_partitionInfo(partInfo[0], &mbr[0x1CE]);
	encode_partitionInfo(partInfo[1], &mbr[0x1BE]);
	
	return 0;
}
    #elif (MOVI_PART_TYPE == MOVI_PART_FAT) 
int make_mmc_partition(int total_block_count, unsigned char *mbr)
{
	int		block_start = 0, block_offset;

	SDInfo		sdInfo;
	PartitionInfo	partInfo[1];
...
///////////////////////////////////////////////////////////	
    ...
    #elif (MOVI_PART_TYPE == MOVI_PART_FAT_SYSTEM) 
int make_mmc_partition(int total_block_count, unsigned char *mbr)
{
	int		block_start = 0, block_offset;
...
///////////////////////////////////////////////////////////	
	/* vendor */
	block_start += block_offset;
	block_offset = calc_unit(VENDOR_PART_SIZE, sdInfo);
...
int g_mx100_part_num = 0;  /* JHLIM  for valid check. */
